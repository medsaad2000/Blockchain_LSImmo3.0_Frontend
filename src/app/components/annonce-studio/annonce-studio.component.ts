...
@Component({
  selector: 'app-annonce-studio',
  templateUrl: './annonce-studio.component.html',
  styleUrls: ['./annonce-studio.component.css']
})
export class AnnonceStudioComponent implements OnInit {
