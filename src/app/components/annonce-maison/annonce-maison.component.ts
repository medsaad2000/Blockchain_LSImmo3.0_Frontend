...
@Component({
  selector: 'app-annonce-maison',
  templateUrl: './annonce-maison.component.html',
  styleUrls: ['./annonce-maison.component.css']
})
export class AnnonceMaisonComponent implements OnInit {
